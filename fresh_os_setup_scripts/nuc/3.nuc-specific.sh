...
sudo apt install -t bullseye-backports firmware-linux firmware-linux-free firmware-linux-nonfree  intel-microcode git vim htop apt-file firmware-linux firmware-linux-free firmware-linux-nonfree intel-microcode git vim htop apt-file sudo yakuake locate
